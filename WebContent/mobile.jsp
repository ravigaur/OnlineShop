	...
	<jsp:directive.include file="header.jsp" />
   	...
   	<div class="container-fluid">
   		...
   		<div class="col-sm-1" >
  			...
  			<div class="col-sm-3" >
  				<img src="images/phone.jpg" class="img-thumbnail" style="margin-top: 5px; height: 290px;" >
				 	
				 		<h4><b> Rs.57000 </b></h4> <input type="submit" onclick="fun();" class="btn btn-info active" value="Add to cart" >			
